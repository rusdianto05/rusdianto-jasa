                                    ...
                                    <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                        ...
                                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                            <div class="flex mt-2 flex-nowrap">
                                                ...
                                                <img :class="{'border-4 border-serv-button': active === {{$thumbnail_item->id}} }" @click="changeThumbnail('{{ url(Storage::url($thumbnail_item->thumbnail)) }}', {{ $thumbnail_item->id }})" src="{{ url(Storage::url($thumbnail_item->thumbnail)) }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer"> 
                                                @empty
                                                   {{-- empty  --}}
                                                @endforelse
