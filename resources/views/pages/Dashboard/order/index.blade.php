                                ...
                                <tr class="text-gray-700 border-b">
                                    ...
                                    <td class="px-1 py-5 text-sm">
                                        ...
                                        <a href="{{ route('member.order.show', $order->id) }}" class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                            Details</a>
                                        <a class="px-4 py-2 mt-2 text-left text-green-500">
                                            Approved
                                        </a> 
                                        ...
                                        <a href="{{ route('member.order.show', $order->id) }}" class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                            Details</a>
                                        <a class="px-4 py-2 mt-2 text-left text-red-500">
                                            Rejected
                                        </a>
                                        @elseif($order->order_status_id == '4')
                                        <a href="{{ route('member.accept.order', $order->id) }}" class="px-4 py-2 mt-1 mr-2 text-white text-left rounded-xl bg-serv-button">
                                            Accept</a>
