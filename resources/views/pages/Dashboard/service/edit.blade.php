                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            @if ($errors->has('title'))
                                                <p class="text-red-500 mb-5 text-sm">{{ $errors->first('title') }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan Service" type="text" name="{{ ('advantage-services['.$advantage_item->id.']') }}" id="advantage-services" autocomplete="advantage-services" 
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                            value="{{ $advantage_item->advantage ?? '' }}"> 
                                            @empty
                                                {{-- empty --}}
                                            @endforelse
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan Kamu" type="text" name="{{ ('advantage-users['.$advantage_user_item->id.']') }}" id="advantage-users" autocomplete="advantage-users" 
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($tagline as $tagline_item)
                                                <input type="text" name="{{ ('taglines['.$tagline_item->id.']') }}" id="taglines" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
